...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если ЗначениеЗаполнено(ПараметрКоманды) Тогда
		Если ЭтоЛичнаяЗадача(ПараметрКоманды) Тогда
			...
			Сообщение.Текст = Нстр("ru='Описание бизнес-процесса недоступно для личных задач!';en='The description of the business process is not available for personal tasks!'");
			Сообщение.Сообщить();
			Возврат;
		КонецЕсли;			
