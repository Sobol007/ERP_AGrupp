...
// +CRM
	CRM_МетодыФормСправочниковСервер.ФизическиеЛицаФормаЭлементаПриСозданииНаСервере(ЭтотОбъект, ФизическоеЛицо);
// -CRM
КонецПроцедуры
...
// +CRM
	CRM_МетодыФормСправочниковКлиент.ФизическиеЛицаФормаЭлементаПослеЗаписи(ЭтотОбъект, ФизическоеЛицо);
// -CRM
КонецПроцедуры
