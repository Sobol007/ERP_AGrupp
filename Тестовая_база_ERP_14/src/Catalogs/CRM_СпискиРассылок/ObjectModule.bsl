...
Процедура ПриЗаписи(Отказ)
	...
	Если МассивРекурсивныхСсылок.Количество() > 0 Тогда
		Отказ = Истина;
		СтрОписаниеОшибки = НСтр("ru='Найдены рекурсивные ссылки в следующих списках рассылок:';en='The recursive references in the following lists of mailings was f:'");
