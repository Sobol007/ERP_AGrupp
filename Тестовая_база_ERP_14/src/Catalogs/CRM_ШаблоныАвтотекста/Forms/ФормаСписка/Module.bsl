...
Процедура ВосстановитьИзМакета(Команда)
	...
	Если ВыделенныеСтроки.Количество() > 0 Тогда
		...
		ПоказатьВопрос(ОписаниеОповещения, НСтр("ru='Выделенные элементы будут перезаполнены из макета справочника. Продолжить?';en='Selected elements will be re-writtena from a model of the reference manual. Continue?'"), РежимДиалогаВопрос.ДаНет,, КодВозвратаДиалога.Да);
	КонецЕсли;
