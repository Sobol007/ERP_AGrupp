...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Служебные реквизиты
	ПоляКлассификатора = "Код, Наименование, НаименованиеПолное, КодАльфа2, КодАльфа3, УчастникЕАЭС, НаименованиеАнгл";
...
Функция ДанныеВыбораЭлементаКлассификатора(Знач ДанныеСтраны)
	...
	Если ЭтоНовый Тогда
		...
		Страна.РЭЙ_НаименованиеАнгл = ДанныеСтраны.НаименованиеАнгл;
		Страна.РЭЙ_УчастникТаможенногоСоюза = ДанныеСтраны.УчастникЕАЭС;
		Страна.Записать();
...
Функция СостояниеКлассификатора()
	Данные = РЭЙ_СлужебныйСервер.ПолучитьТаблицуКлассификатораСтран();
	Данные.Колонки.КодЧисловой.Имя = "Код";
