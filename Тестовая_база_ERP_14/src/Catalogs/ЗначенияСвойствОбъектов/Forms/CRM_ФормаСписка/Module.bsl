	...
	Если ПустаяСтрока(СтрокаЗаголовка) Тогда
		...
		Если ЗначениеЗаполнено(Свойство) Тогда
			Если НЕ Параметры.РежимВыбора Тогда
				СтрокаЗаголовка = НСтр("ru='Значения свойства %1';en='Property Values ​​for %1'");
			ИначеЕсли ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("ru='Выберите группу значений свойства %1';en='Select property value group %1'");
			Иначе
				СтрокаЗаголовка = НСтр("ru='Выберите значение свойства %1';en='Select property value %1'");
			КонецЕсли;
		...
		ИначеЕсли Параметры.РежимВыбора Тогда
			...
			Если ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("ru='Выберите группу значений свойства';en='Select a group of property values'");
			Иначе
				СтрокаЗаголовка = НСтр("ru='Выберите значение свойства';en='Select a property value'");
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
