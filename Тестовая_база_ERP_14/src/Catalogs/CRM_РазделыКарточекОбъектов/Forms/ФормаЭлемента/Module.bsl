...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Владельцы карточек
	МассивОбъектов = CRM_ОбщегоНазначенияПовтИсп.МассивОбъектовРасширеннойКарточки();
	...
	Элементы.ПоложениеРаздела.СписокВыбора.Добавить("Лево" , НСтр("ru='Лево';en='Left'"));
	Элементы.ПоложениеРаздела.СписокВыбора.Добавить("Право", НСтр("ru='Право';en='Right'"));
