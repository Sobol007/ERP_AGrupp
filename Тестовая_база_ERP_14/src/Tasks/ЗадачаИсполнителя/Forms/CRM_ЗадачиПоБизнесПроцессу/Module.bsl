...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПоказыватьЗадачиСписокВыбора.Добавить(2, НСтр("ru='Не выполненные';en='not fulfill'"));
	ПоказыватьЗадачиСписокВыбора.Добавить(1, НСтр("ru='Выполненные';en='the fulfill'"));
	ПоказыватьЗадачиСписокВыбора.Добавить(0, НСтр("ru='Все';en='All'"));
	ПоказыватьЗадачи	= 2;
	...
	УстановитьОтборВСпискеПоДоступнымпользователям(Список, МассивЭлементовОтбора);
	...
	Элементы.ПоИсполнителю.ПараметрыВыбора = Новый ФиксированныйМассив(ПараметрыВыбораПользователь);
	Элементы.ПоАвтору.ПараметрыВыбора = Новый ФиксированныйМассив(ПараметрыВыбораПользователь);
	// -Доступные пользователи	
КонецПроцедуры
...
Функция СформироватьОписаниеБизнесПроцесса(Задача)
	...
	//СписокРеквизитов.Добавить("Проект"					,НСтр("ru='Процесс:';en='Process:'"));
	СписокРеквизитов.Добавить("Важность"					,НСтр("ru='Важность:';en='Importance:'"));
	СписокРеквизитов.Добавить("ДатаСтарта"					,НСтр("ru='Дата старта:';en='Start date:'"));
	СписокРеквизитов.Добавить("Организация"					,НСтр("ru='Организация:';en='Organization:'"));
	СписокРеквизитов.Добавить("Партнер"						,НСтр("ru='Партнер:';en='Partner:'"));
	СписокРеквизитов.Добавить("КонтактноеЛицо"				,НСтр("ru='Контактное лицо:';en='The login and password for connecting to the Internet-based user support services will be removed from the program."
""
"Disable Internet support?'"));
	СписокРеквизитов.Добавить("Предмет"						,НСтр("ru='Предмет:';en='Subject:'"));
	
	СписокРеквизитов_1 = Новый СписокЗначений;
	СписокРеквизитов_1.Добавить("Автор"						,НСтр("ru='Автор:';en='Author:'"));
	СписокРеквизитов_1.Добавить("Дата"						,НСтр("ru='Дата создания:';en='Creation date:'"));
	СписокРеквизитов_1.Добавить("ПланируемаяДатаЗавершения"	,НСтр("ru='Планируемая дата завершения:';en='Schedulable date of completion:'"));
	СписокРеквизитов_1.Добавить("Подразделение"				,НСтр("ru='Подразделение:';en='Department:'"));
...
Функция СформироватьИсториюБизнесПроцесса(Задача)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ТабОбъектов.Количество() > 0 Тогда
			СтрокаОбъектовПоЗадаче = "
			|<P><span style='font-size: 10pt;'><EM>&nbsp&nbsp&nbsp" + НСтр("ru='Введенные на этапе объекты:';en='The objects enter at a stage:'")+"</EM></span></P>";
		КонецЕсли;
	...
	Иначе
		Если НЕ Пользователи.РолиДоступны("ПолныеПрава") Тогда
			Если ЗначениеЗаполнено(ТекущаяСтрокаСписка.РольИсполнителя) И НЕ ЗначениеЗаполнено(ТекущаяСтрокаСписка.Исполнитель) Тогда
				СписокВозможныхИсполнителей														= CRM_БизнесПроцессыСервер.ПолучитьВозможныхИсполнителейПоРоли(ТекущаяСтрокаСписка.РольИсполнителя);
