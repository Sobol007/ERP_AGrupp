...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	// + CRM Модуль отключаем проверку табличной части из-за наличия разделителей строк
	ПродажиСервер.ПроверитьКорректностьЗаполненияДокументаПродажи(ЭтотОбъект, Истина);
	Возврат;
	// -CRM Модуль
