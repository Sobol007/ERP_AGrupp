...
Функция ПолучитьДанныеОбъекта(СсылкаНаОбъект)
	...
	//
	//ДанныеОбъекта.Вставить("Дата",	Формат(ТекущаяДата(),"ДЛФ=D"));
	//ДанныеОбъекта.Вставить("Номер",	Объект.Номер);
	//
	//СведенияОбОрганизации	= CRM_ОбщегоНазначенияСервер.СведенияОЮрФизЛице(Объект.Организация, ТекущаяДата(), ,);
	...
	//
	//СведенияОКонтрагенте	= CRM_ОбщегоНазначенияСервер.СведенияОЮрФизЛице(Объект.Контрагент, ТекущаяДата(), ,);
