...
Процедура ЗаполнитьТаблицуОповещений()
	...
	ТаблицаОповещений.Колонки.Добавить("Канал", ОписаниеТиповКанал);
	ТаблицаОповещений.Колонки.Добавить("СрокОповещения", ОписаниеТиповСрок);
	ТаблицаОповещений.Колонки.Добавить("Периодичность", ОписаниеТиповПериод);
	ТаблицаОповещений.Колонки.Добавить("ДатаОповещения", ОписаниеТиповДата);
	...
	ЭтаФорма.ТаблицаОповещения.Загрузить(ТаблицаОповещений);
