...
Процедура ЗаполнитьТаблицуРасчетовСервер()
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОтбор(КомпоновщикОтбор.Настройки, "Организация", Организация,,ЗначениеЗаполнено(Организация));
	КомпоновкаДанныхКлиентСервер.ДобавитьОтбор(КомпоновщикОтбор.Настройки, "Контрагент", Контрагент,,ЗначениеЗаполнено(Контрагент));
