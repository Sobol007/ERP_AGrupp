...
Процедура Применить(Команда)
	...
	Если НЕ Отказ Тогда
		...
		СтруктураВозврата.Вставить("УдалитьРасшифровкаПоЗаказам", РасшифровкаПоЗаказам);
		СтруктураВозврата.Вставить("УдалитьРасшифровкаПоПартнерам", РасшифровкаПоПартнерам);
		СтруктураВозврата.Вставить("УдалитьРасшифровкаПоДоговорам", РасшифровкаПоДоговорам);
