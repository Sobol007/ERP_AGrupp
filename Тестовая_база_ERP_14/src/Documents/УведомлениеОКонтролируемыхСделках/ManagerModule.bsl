...
Функция ПолучитьТекстЗапросаПоКонтролируемымСделкам_2018() Экспорт
	...
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	Листы1А.Контрагент.ГоловнойКонтрагент
	|ИЗ
	|	Листы1А КАК Листы1А
	|ГДЕ
	|	Листы1А.Контрагент <> ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)
	|	И Листы1А.Контрагент.ГоловнойКонтрагент <> ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)
	|	И Листы1А.Контрагент.ГоловнойКонтрагент <> Листы1А.Контрагент
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	Листы1А.Комиссионер.ГоловнойКонтрагент
	|ИЗ
	|	Листы1А КАК Листы1А
	|ГДЕ
	|	Листы1А.Комиссионер <> ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)
	|	И Листы1А.Комиссионер.ГоловнойКонтрагент <> ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)
	|	И Листы1А.Комиссионер.ГоловнойКонтрагент <> Листы1А.Комиссионер
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
