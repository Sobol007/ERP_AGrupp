...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если бзПоискПоПодстроке Тогда
		Элементы.бзСтрокаПоиска.ПодсказкаВвода = НСтр("ru='[Поиск по подстроке]';en='[Поиск по подстроке]'");
	Иначе
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыбзПроекты
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыбзРешения
