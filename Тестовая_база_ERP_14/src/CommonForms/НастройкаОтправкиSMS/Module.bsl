...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// +CRM
	// +SMS4B
	SMS4B_Взаимодействия.SMS4B_ФормаНастроекПриСозданииНаСервере(ЭтотОбъект);
	// -SMS4B
	// -CRM
...
Процедура ПровайдерSMSПриИзменении(Элемент)
	...
	// +CRM
	// +SMS4B
	SMS4B_ПриИзмененииПровайдераСервер();
	// -SMS4B
	// -CRM
...
&НаКлиенте
Процедура Подключаемый_SMS4B_ИмяОтправителяОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	
	SMS4B_ВзаимодействияКлиент.SMS4B_ИмяОтправителяОбработкаВыбора(ЭтотОбъект, Элемент, ВыбранноеЗначение, СтандартнаяОбработка);
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_SMS4B_ОткрытьРасширенныеНастройки(Команда)
	
	SMS4B_ВзаимодействияКлиент.SMS4B_ОткрытьРасширенныеНастройки(ЭтотОбъект);
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_SMS4B_ОткрытьОписаниеСервиса(Команда)
	
	SMS4B_ВзаимодействияКлиент.SMS4B_ОткрытьОписаниеСервиса(ЭтотОбъект);
	
КонецПроцедуры

&НаСервере
Процедура SMS4B_ПриИзмененииПровайдераСервер()
	
	SMS4B_Взаимодействия.SMS4B_ФормаНастроекПровайдерПриИзменении(ЭтотОбъект);
