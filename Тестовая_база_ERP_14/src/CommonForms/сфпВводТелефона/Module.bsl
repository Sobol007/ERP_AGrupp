...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// +СофтФон
	Если Параметры.Свойство("сфпВремяЗадержкиНабораДобавочногоНомера") Тогда
		сфпВремяЗадержкиНабораДобавочногоНомера = Параметры.сфпВремяЗадержкиНабораДобавочногоНомера;
	КонецЕсли;
	сфпВремяЗадержкиНабораДобавочногоНомера = ?(сфпВремяЗадержкиНабораДобавочногоНомера = 0, 5, сфпВремяЗадержкиНабораДобавочногоНомера);
	// -СофтФон
...
&НаКлиенте
Процедура сфпВремяЗадержкиНабораДобавочногоНомераПриИзменении(Элемент)

	Если сфпВремяЗадержкиНабораДобавочногоНомера = 0 Тогда
		сфпВремяЗадержкиНабораДобавочногоНомера = 5;
	КонецЕсли;
...
Функция РезультатВыбора()
	...
	// +СофтФон
	Результат.Вставить("сфпВремяЗадержкиНабораДобавочногоНомера", сфпВремяЗадержкиНабораДобавочногоНомера);
	// -СофтФон
