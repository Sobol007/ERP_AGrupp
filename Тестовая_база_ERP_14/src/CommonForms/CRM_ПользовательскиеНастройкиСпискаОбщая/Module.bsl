...
#Область ОбработчикиСобытийЭлементовТаблицыФормыТаблицаГруппировка
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыТаблицаУсловноеОформление
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыДеревоПользовательскиеНастройкиСписка
...
Процедура ДеревоПользовательскиеНастройкиСпискаПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа)
	...
	НаименованиеНастройки = НСтр("ru='Новая настройка';en='New settings'");
