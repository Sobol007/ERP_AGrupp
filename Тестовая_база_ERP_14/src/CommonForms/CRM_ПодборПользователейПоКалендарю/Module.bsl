...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Пользователи") И ТипЗнч(Параметры.Пользователи) = Тип("Массив") Тогда
		Заголовок = НСтр("ru='Пользователи';en='Users'");
	...
	ИначеЕсли Параметры.Свойство("Место") Тогда
		Заголовок = НСтр("ru='Помещения';en='Locations'");
	...
	Если Параметры.Свойство("ЗакрыватьФормуПослеВыбораПериодов") Тогда
		...
		Элементы.КалендарьТабличныйДокументКонтекстноеМенюКомандаДобавитьПользователяСПериодом.Заголовок = НСтр("ru='Выбрать период';en='Select the period'");
	КонецЕсли;
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыВыбранныеПользователиСПериодами
