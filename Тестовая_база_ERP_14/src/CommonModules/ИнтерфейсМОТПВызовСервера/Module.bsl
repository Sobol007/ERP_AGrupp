...
#Область Авторизация
	...
	Функция ЗапроситьПараметрыАвторизации() Экспорт
		...
		HTTPЗапрос  = Новый HTTPЗапрос("private-office-api/private/v2/auth/key", ЗаголовокHTTP);
	...
	Функция ЗапроситьКлючСессии(ПараметрыЗапросаПоОрганизации) Экспорт
		...
		HTTPЗапрос  = Новый HTTPЗапрос("private-office-api/private/v2/auth/simpleSignIn", ЗаголовокHTTP);
