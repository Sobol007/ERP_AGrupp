...
//  Элемент	 - ЭлементыФормы - Поле ввода тега.
//
...
//  ТекущееПодразделение - СправочникСсылка	- Текущие подразделение. 
//
...
//  Элемент				 - ЭлементыФормы - Элементы формы.
//  ПолеДата			 - Строка - Строка, для проверки элемента отбора.
//  ВключатьПросроченные - Булево - Включать просроченные.
// 
...
// Параметры:
//  Форма		 - УправляемаяФорма	- Форма списка
//  ИмяСписка	 - Строка - Имя динамического списка формы для которого очищается отбор.
//  ПолеДата	 - Строка - Строка, очищения элемента отбора.
//
...
//
// Параметры:
//  ОбъектМетаданных				 - Строка - Объект метаданных.
//  Форма		 					 - УправляемаяФорма	- Форма списка
//  ИмяСписка						 - Строка	 - Имя динамического списка формы для которого устанавливается отбор.
//  Элемент				 			 - ЭлементыФормы - Элементы формы.
//  СтандартнаяОбработка			 - Булево	 - Стандартная обработка нажатия.
//  ЗаписатьСсылкиВСписок			 - Булево	 - Записывать ссылки в список.
//  СписокОбъектов					 - СписокЗначений - Список объектов.
//  ОтбиратьПоТегам					 - Булево	 - Отбирать по тэгов.
//  ОтбиратьОбъектыБезТегов			 - Булево	 - Отбирать без тэгов.
//  СписокВышестоящихПодразделений	 - СписокЗначений  - Список вышестоящих подразделений.
// 
// Возвращаемое значение:
//  Булево - Включен или выключен отбор по данному элементу
//
...
// Параметры:
//  Форма	 - УправляемаяФорма	- Форма списка
//  Отбор1	 - Строка - Значение отбора на форме списка (по умолчанию "").
//  Отбор2	 - Строка - Значение отбора на форме списка (по умолчанию "").
//  Отбор3	 - Строка - Значение отбора на форме списка (по умолчанию "").
//  Отбор4	 - Строка - Значение отбора на форме списка (по умолчанию "").
//  Отбор5	 - Строка - Значение отбора на форме списка (по умолчанию "").
//  Отбор6	 - Строка - Значение отбора на форме списка (по умолчанию "").
//
...
Процедура ВыборВариантаОтбора(Форма, Команда) Экспорт
	...
	Иначе
		...
		Элементы[Команда.Имя].ЦветФона = ОбщегоНазначенияКлиентПовтИсп.ЦветСтиля("CRM_ОсновнойГолубой");
