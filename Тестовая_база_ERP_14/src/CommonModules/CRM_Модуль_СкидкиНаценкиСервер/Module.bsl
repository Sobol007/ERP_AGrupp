...
Функция Рассчитать(Объект, ВходныеПараметры) Экспорт
	...
	Если ТипЗнч(Объект.Ссылка) = Тип("ДокументСсылка.CRM_Интерес") Тогда
		
		РезультатРасчета = РассчитатьПоИнтересуКлиента(Объект, ВходныеПараметры);
...
//   * ПараметрыРасчета - Структура - Структура параметров расчета.
//
Функция РассчитатьПоИнтересуКлиента(Объект, ВходныеПараметры) Экспорт
	...
	ПараметрыЗапроса.Вставить("ВозвратТары", Ложь);
...
//		Объект.КартаЛояльности);
		Справочники.КартыЛояльности.ПустаяСсылка());
...
//	ПараметрыРасчета.ФормаОплаты = Объект.ФормаОплаты;
	ПараметрыРасчета.ФормаОплаты = Перечисления.ФормыОплаты.ПустаяСсылка();
...
//	ПараметрыРасчета.ГрафикОплаты = Объект.ГрафикОплаты;
	ПараметрыРасчета.ГрафикОплаты = Справочники.ГрафикиОплаты.ПустаяСсылка();
	
	// Карты лояльности
//	ПараметрыРасчета.КартаЛояльности = Объект.КартаЛояльности;
	ПараметрыРасчета.КартаЛояльности = Справочники.КартыЛояльности.ПустаяСсылка();
...
//	ПараметрыРасчета.Пользователь               = Объект.Менеджер;
	ПараметрыРасчета.Пользователь               = Объект.Ответственный;
	...
	Если ВходныеПараметры.ПрименятьКОбъекту Тогда
		...
		ПрименитьРезультатРасчетаКИнтересуКлиента(Объект, ПримененныеСкидкиНаценки);
...
Процедура ПрименитьРезультатРасчета(Объект, ПримененныеСкидки, РеализацияСверхЗаказа = Ложь) Экспорт
	...
	Если ТипЗнч(Объект.Ссылка) = Тип("ДокументСсылка.CRM_Интерес") Тогда
		...
		ПрименитьРезультатРасчетаКИнтересуКлиента(Объект, ПримененныеСкидки);
...
//    * ПараметрыРасчета - Структура - Структура параметров расчета.
//
Процедура ПрименитьРезультатРасчетаКИнтересуКлиента(Объект, ПримененныеСкидкиНаценки) Экспорт
