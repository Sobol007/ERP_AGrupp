...
Процедура ОбновитьОблакоТегов(Форма) Экспорт
	...
	Для Каждого СтрокаТегов Из СписокТеговОбработанный Цикл
		...
		КомпонентыТега.Добавить(Новый ФорматированнаяСтрока(БиблиотекаКартинок.CRM_УдалитьСиняя, , , , "ТегИД_" + СтрокаТегов.НомерСтроки));
		...
		ЭлементТег.ЦветТекста = ЦветТега;
...
//  Подразделение					 - СправочникСсылка.СтруктураПредприятия - Подразделение, чьи теги должны отображаться первыми.
//  СписокВышестоящийхПодразделений	 - СправочникСсылка.СтруктураПредприятия - подразделения, чьи теги выводятся после Подразделение.										 - 
//  ИспользоватьТегНет				 - Булево								 - Использование тегов.
//
...
// Параметры:
//  Форма - УправляемаяФорма - Форма списка.
//  БудущиеПериоды - Булево - Добавление отборов будущих отборов.   
//
...
//
// Параметры:
//  Элементы - Элементы - Элементы формы. 
//
...
// Процедура одноименного обработчика При чтении на сервере.
//
// Параметры:
