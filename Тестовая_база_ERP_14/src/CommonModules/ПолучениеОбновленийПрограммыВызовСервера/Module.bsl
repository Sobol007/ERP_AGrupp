...
Функция ИнформацияОДоступномОбновлении() Экспорт
	...
	Если Результат.Исправления <> Неопределено Тогда
		ИсправленияДляНовойВерсии = Результат.Исправления.НайтиСтроки(Новый Структура("ДляНовойВерсии", Истина)).Количество();
		ИсправленияДляТекущейВерсии = Результат.Исправления.НайтиСтроки(Новый Структура("ДляТекущейВерсии", Истина)).Количество();
	КонецЕсли;
