...
//
// Параметры:
//  ПриемникЗначения	 - ЗначенияПараметровДанныхКомпоновкиДанных - Приемник значений.
//  ИсточникЗначения	 - ЗначенияПараметровДанныхКомпоновкиДанных - Источник значений.
//  ПроверятьДоступность - Булево - Проверять доступность.
...
//
// Параметры:
//  ЭлементСтруктуры - Произвольный	 - Элемент структуры.
//  Поле			 - ПолеКомпоновкиДанных, Строка - Поле компановки данных.
//  Значение		 - Произвольный - Значение.
//  ВидСравнения	 - ВидСравненияКомпоновкиДанных	 - Вид сравнения компоновки данных.
//  Использование	 - Булево - Использование отбора.
// 
...
//
// Параметры:
//  НастройкиПриемник	 - НастройкиКомпоновкиДанных - Настройки компановки приемник.
//  НастройкиИсточник	 - НастройкиВложенногоОбъектаКомпоновкиДанных - Настройки компановки источник.
//
...
//
// Параметры:
//  Элементы	 - Элементы - Элементы полей СКД.
//  ПолноеИмя	 - Строка - Строка с полным именем.
// 
// Возвращаемое значение:
//  Элементы - Найденное поле.
//
