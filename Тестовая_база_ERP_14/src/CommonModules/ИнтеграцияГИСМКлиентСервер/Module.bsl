	...
	Исключение
		...
		#Если НЕ ТонкийКлиент И НЕ МобильныйКлиент Тогда
			ЗаписьЖурналаРегистрации(
				...
				НСтр("ru = 'Ошибка отправки POST-запроса к серверу ГИСМ 195.149.110.235';
					|en = 'Ошибка отправки POST-запроса к серверу ГИСМ 195.149.110.235'") + Символы.ПС + ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		#КонецЕсли
	КонецПопытки;
