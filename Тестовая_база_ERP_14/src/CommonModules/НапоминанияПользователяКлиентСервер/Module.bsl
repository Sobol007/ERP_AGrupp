...
Функция ЗаменитьЕдиницуИзмеренияНаМножитель(Знач Единица)
	...
	Если ПервыеТриСимвола = НСтр("ru = 'нед';
								|en = 'week'") Или ПервыеТриСимвола = НСтр("ru = 'н';
																			|en = 'n'") Тогда
	...
	ИначеЕсли ПервыеТриСимвола = НСтр("ru = 'ден';
		  ...
		  Или ПервыеТриСимвола = НСтр("ru = 'дн';
										|en = 'days'")
		  Или ПервыеТриСимвола = НСтр("ru = 'д';
										|en = 'd'") Тогда
		Результат = 60*60*24;
	ИначеЕсли ПервыеТриСимвола = НСтр("ru = 'час';
										|en = 'hour'") Или ПервыеТриСимвола = НСтр("ru = 'ч';
																				|en = 'h'") Тогда
		Результат = 60*60;
	ИначеЕсли ПервыеТриСимвола = НСтр("ru = 'мин';
										|en = 'min'") Или ПервыеТриСимвола = НСтр("ru = 'м';
																				|en = 'm'") Тогда
		Результат = 60;
	ИначеЕсли ПервыеТриСимвола = НСтр("ru = 'сек';
										|en = 'sec'") Или ПервыеТриСимвола = НСтр("ru = 'с';
																				|en = 'from'") Тогда
		Результат = 1;
	КонецЕсли;
