...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Зависимости) Экспорт
	...
	// +CRM
	SMS4B_Взаимодействия.ПриОпределенииНастроекРегламентныхЗаданий(Зависимости);
	// -CRM
...
Процедура ПроверитьСтатусыДоставкиSMS(СообщениеSMS, Модифицированность) Экспорт
	...
	Если SMS4B_ОтправкаSMS.SMS4B_ИспользоватьSMS4B() Тогда
		SMS4B_Взаимодействия.ПроверитьСтатусыДоставкиSMS(СообщениеSMS, Модифицированность);
		Возврат;
	КонецЕсли;
	// -SMS4B
	// -CRM
...
Функция ОтправкаSMSПоДокументу(Документ) Экспорт
	...
	// +SMS4B
	Если SMS4B_ОтправкаSMS.SMS4B_ИспользоватьSMS4B() Тогда
		Возврат SMS4b_Взаимодействия.ОтправкаSMSПоДокументу(Документ);
	КонецЕсли;
	// -SMS4B
	// -CRM
...
Процедура ОтправкаSMS() Экспорт
	...
	// +SMS4B
	Если SMS4B_ОтправкаSMS.SMS4B_ИспользоватьSMS4B() Тогда
		SMS4b_Взаимодействия.ОтправкаSMS();
		Возврат;
	КонецЕсли;
	// -SMS4B
	// -CRM
...
Процедура ОбновлениеСтатусовДоставкиSMS() Экспорт
	...
	// +SMS4B
	Если SMS4B_ОтправкаSMS.SMS4B_ИспользоватьSMS4B() Тогда
		SMS4b_Взаимодействия.ОбновлениеСтатусовДоставкиSMS();
		Возврат;
	КонецЕсли;
	// -SMS4B
	// -CRM
