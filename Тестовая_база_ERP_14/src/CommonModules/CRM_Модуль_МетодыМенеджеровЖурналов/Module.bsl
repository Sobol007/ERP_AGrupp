...
Процедура ОбработкаПолученияФормОбъектов(Источник, ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка) Экспорт
	...
	Если ВидФормы = "ФормаСписка" Тогда
		...
		ВыбраннаяФорма = "Обработка.CRM_УниверсальныйЖурналДокументов.Форма.Форма";
		Параметры.Вставить("ВидЖурнала", Справочники.CRM_ГруппыУниверсальногоЖурнала.Контакты);
		Параметры.Вставить("БлокироватьИзменениеВидаЖурнала", Истина);
		Параметры.Вставить("ОткрытаФормаЖурналаВзаимодействия", Истина);
