...
Функция СоздатьЗаполнитьСообщение(Выборка)
	...
	Если ПровайдерSMS = Перечисления.ПровайдерыSMS.SMS4B Тогда
		...
		Иначе
			...
			НовоеСообщение.ДатаАктуальностиОтправки	= НовоеСообщение.ДатаКогдаОтправить + (НастройкиСервиса.СрокЖизниСообщений * 3600);
		КонецЕсли;
	КонецЕсли;
	...
	ВзаимодействияКлиентСервер.УстановитьСостояниеИсходящееДокументСообщениеSMS(НовоеСообщение);
...
Функция ПолучитьДатуОповещения(ПараметрыОповещения) Экспорт
	...
	ИЛИ ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.ОповещатьОбОкончанииСрокаЗадач Тогда
		...
		Если ТипЗнч(ПараметрыОповещения.Предмет) = Тип("ДокументСсылка.удалитьCRM_Мероприятие") Тогда
...
Функция СформироватьТекстОповещенияПоСобытию(ПараметрыОповещения)
	...
	Если ПараметрыОповещения.Состояние.Новое ИЛИ ПараметрыОповещения.ЭтоНовыйУчастник Тогда
		...
		Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			...
			ТекстСодержания = НСтр("ru='Вас включили в состав участников встречи: ""';en='You are included in composition of participants of a meeting:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + НСтр("ru='"" начало в';en='"" starts at'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'");
			Если ЗначениеЗаполнено(ПараметрыОповещения.Предмет.Место) Тогда
				ТекстСодержания = ТекстСодержания + Символы.ПС + НСтр("ru='место проведения:';en='location:'") + " " + СокрЛП(ПараметрыОповещения.Предмет.Место);
			КонецЕсли;
		Иначе
			ТекстТемы = НСтр("ru='Вас включили в состав участников встречи: ""';en='You are included in composition of participants of a meeting:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """";
			
			УчастникиСобытия = СформироватьСписокУчастниковСобытияСтрокой(ПараметрыОповещения.Предмет);
			
			ТекстСодержания = НСтр("ru='Вас включили в состав участников встречи';en='You are included in composition of participants of a meeting'") + " " + Символы.ПС + 
			НСтр("ru='Тема:';en='Topic:'") + " " + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема))+ Символы.ПС + 
			НСтр("ru = 'Когда:';en='When:'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд ММММ'") + НСтр("ru = ' с'") + " " + 
			...
			НСтр("ru='Где:';en='Where:'") + " " + ?(ЗначениеЗаполнено(ПараметрыОповещения.Предмет.Место),ПараметрыОповещения.Предмет.Место,НСтр("ru='не указано';en='it is not specif'")) + Символы.ПС +
			НСтр("ru='Описание:';en='Description:'") + " " + ?(ЗначениеЗаполнено(ПараметрыОповещения.Предмет.Описание),СокрЛП(ПараметрыОповещения.Предмет.Описание),НСтр("ru='не указано';en='it is not specif'")) +
			?(НЕ УчастникиСобытия = "",Символы.ПС + НСтр("ru='Участники:';en='Participants:'") + " " + Символы.ПС + УчастникиСобытия,"") + Символы.ПС;
			...
			ТекстСодержания = ТекстСодержания + НСтр("ru='Ответственный:';en='Responsible:'") + " " + ПараметрыОповещения.Предмет.Ответственный;
			...
			Если ЗначениеЗаполнено(ИнформацияОтветственного.Телефон) Тогда
				ТекстСодержания = ТекстСодержания + Символы.ПС + Символы.Таб + НСтр("ru='Телефон:';en='Phone:'") + " " + СокрЛП(ИнформацияОтветственного.Телефон);
			КонецЕсли;
			
			// ВРЕМЕННО
			ТекстСодержания = ТекстСодержания + Символы.ПС + Символы.ПС +
			"++++++++++++++++++++++++++ ТЕКСТ НАПОМИНАНИЯ И СМС +++++++++++++++++++++++++++++++++" + Символы.ПС +
			НСтр("ru='Вас включили в состав участников встречи: ""';en='You are included in composition of participants of a meeting:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + НСтр("ru='"" начало в';en='"" starts at'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'");
			Если ЗначениеЗаполнено(ПараметрыОповещения.Предмет.Место) Тогда
				ТекстСодержания = ТекстСодержания + Символы.ПС + НСтр("ru='место проведения:';en='location:'") + " " + СокрЛП(ПараметрыОповещения.Предмет.Место);
			КонецЕсли;
	...
	Иначе
		...
		Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			...
			//	
			//	ТекстСодержания = ?(ПараметрыОповещения.Состояние.Отменено,НСтр("ru='Отменено проведение встречи: ""';en='Carrying out of a meeting are cancel:""'")
			//															 ,НСтр("ru='Завершено проведение встречи: ""';en='Carrying out of a meeting is completed:""'")) + 
			//	СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + НСтр("ru='"" окончание в';en='"" ends at'") + " " + Формат(ПараметрыОповещения.Предмет.ОкончаниеМероприятия,"ДФ='дд.ММ.гг ЧЧ:мм'");
			//	
			// Иначе
				Если ПараметрыОповещения.Состояние.ИзмененаДата И ПараметрыОповещения.Состояние.ИзмененоМесто Тогда
					
					ТекстСодержания =	НСтр("ru='Изменена дата и место проведения встречи: ""';en='Meeting date and venue has been changed:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """" + Символы.ПС +
										НСтр("ru = 'Когда:';en='When:'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'") + " - " + 
				...
				ИначеЕсли ПараметрыОповещения.Состояние.ИзмененаДата Тогда
					...
					ТекстСодержания =	НСтр("ru='Изменена дата проведения встречи: ""';en='Meeting date has been changed:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """" + Символы.ПС +
										НСтр("ru = 'Когда:';en='When:'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'") + " - " + 
				...
				ИначеЕсли ПараметрыОповещения.Состояние.ИзмененоМесто Тогда
					...
					ТекстСодержания =	НСтр("ru='Изменено место проведения встречи: ""';en='Meeting venue has been changed:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """" + Символы.ПС +
										НСтр("ru='Место проведения:';en='location:'") + " " + СокрЛП(ПараметрыОповещения.Предмет.Место);
		...
		Иначе
			...
			// Если ПараметрыОповещения.Состояние.Отменено ИЛИ ПараметрыОповещения.Состояние.Завершено Тогда
			//	
			//	ТекстТемы = ?(ПараметрыОповещения.Состояние.Отменено,НСтр("ru='Отменено проведение встречи: ""';en='Carrying out of a meeting are cancel:""'")
			//															 ,НСтр("ru='Завершено проведение встречи: ""';en='Carrying out of a meeting is completed:""'")) + 
			//	СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """";
			//	
			//	ТекстСодержания = ?(ПараметрыОповещения.Состояние.Отменено,НСтр("ru='Отменено проведение встречи: ""';en='Carrying out of a meeting are cancel:""'")
			//															 ,НСтр("ru='Завершено проведение встречи: ""';en='Carrying out of a meeting is completed:""'")) + 
			//	СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + НСтр("ru='"" окончание в';en='"" ends at'") + " " + Формат(ПараметрыОповещения.Предмет.ОкончаниеМероприятия,"ДФ='дд.ММ.гг ЧЧ:мм'") + Символы.ПС;
			//	
			//	Если ПараметрыОповещения.Состояние.Отменено Тогда
			//		ТекстСодержания = ТекстСодержания + 
			//		НСтр("ru='По причине: ""';en='For the reason:""'") + ?(ЗначениеЗаполнено(ПараметрыОповещения.Предмет.ПричинаОтказа),СокрЛП(ПараметрыОповещения.Предмет.ПричинаОтказа),НСтр("ru='не указана';en='it is not specif'")) + Символы.ПС;
			//	КонецЕсли;
			//	
			...
			//	ТекстСодержания = ТекстСодержания + Символы.ПС + Символы.ПС +
			//	"++++++++++++++++++++++++++ ТЕКСТ НАПОМИНАНИЯ И СМС +++++++++++++++++++++++++++++++++" + Символы.ПС +
			//	?(ПараметрыОповещения.Состояние.Отменено,НСтр("ru='Отменено проведение встречи: ""';en='Carrying out of a meeting are cancel:""'")
			//															 ,НСтр("ru='Завершено проведение встречи: ""';en='Carrying out of a meeting is completed:""'")) + 
			//	СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + НСтр("ru='"" начало в';en='"" starts at'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'");
			//	
			// Иначе
				Если ПараметрыОповещения.Состояние.ИзмененаДата И ПараметрыОповещения.Состояние.ИзмененоМесто Тогда
					
					ТекстТемы = НСтр("ru='Изменена дата и место проведения встречи: ""';en='Meeting date and venue has been changed:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """";
				...
				ИначеЕсли ПараметрыОповещения.Состояние.ИзмененаДата Тогда
					...
					ТекстТемы = НСтр("ru='Изменена дата проведения встречи: ""';en='Meeting date has been changed:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """";
				...
				ИначеЕсли ПараметрыОповещения.Состояние.ИзмененоМесто Тогда
					...
					ТекстТемы = НСтр("ru='Изменено место проведения встречи: ""';en='Meeting venue has been changed:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """";
				...
				Если ПараметрыОповещения.Состояние.ИзмененаДата И ПараметрыОповещения.Состояние.ИзмененоМесто Тогда
					...
					ТекстСодержания  = ТекстСодержания + НСтр("ru='Изменена дата и место проведения встречи: ""';en='Meeting date and venue has been changed:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """"  + Символы.ПС +
										НСтр("ru = 'Когда:';en='When:'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'") + " - " + 
				...
				ИначеЕсли ПараметрыОповещения.Состояние.ИзмененаДата Тогда
					...
					ТекстСодержания  = ТекстСодержания + НСтр("ru='Изменена дата проведения встречи: ""';en='Meeting date has been changed:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """"  + Символы.ПС +
										НСтр("ru = 'Когда:';en='When:'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'") + " - " + 
																 Формат(ПараметрыОповещения.Предмет.ОкончаниеМероприятия,"ДФ='дд.ММ.гг ЧЧ:мм'");
										
				ИначеЕсли ПараметрыОповещения.Состояние.ИзмененоМесто Тогда
					
					ТекстСодержания  = ТекстСодержания + НСтр("ru='Изменено место проведения встречи: ""';en='Meeting venue has been changed:""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """"  + Символы.ПС +
										НСтр("ru='Место проведения:';en='location:'") + " " + СокрЛП(ПараметрыОповещения.Предмет.Место);
...
Функция СформироватьТекстСодержанияДляОповещения(Предмет)
	...
	ИначеЕсли ТипЗнч(Предмет) = Тип("ДокументСсылка.CRM_РассылкаЭлектронныхПисем") Тогда
		...
		Если ЗначениеЗаполнено(Предмет.Тема) Тогда
			Текст = Текст + НСтр("ru='Тема:';en='Topic:'") + " " + Предмет.Тема;
		КонецЕсли;
		Если ЗначениеЗаполнено(Предмет.Комментарий) Тогда
			Текст = Текст + ?(ЗначениеЗаполнено(Текст), РазделительПС, "");
			Текст = Текст + Предмет.Комментарий;
	...
	ИначеЕсли ТипЗнч(Предмет) = Тип("БизнесПроцессСсылка.CRM_БизнесПроцесс") Тогда
		...
		Если ЗначениеЗаполнено(Предмет.Наименование) Тогда
			Текст = Текст + НСтр("ru='Тема:';en='Topic:'") + " " + Предмет.Наименование;
		КонецЕсли;
		Если ЗначениеЗаполнено(Предмет.Партнер) Тогда
			Текст = Текст + ?(ЗначениеЗаполнено(Текст), РазделительПС, "");
			Текст = Текст + Строка(Предмет.Партнер);
...
//  ПроверятьВозможныеПовторыИзмерений	 - Булево - Проверка возможных повторов измерений.
//
...
Функция ПолучитьНастройкиОповещенийПользователей(Пользователи)
	...
	|ГДЕ
	|	ПользовательскиеНастройки.ВидОповещения.Родитель = ЗНАЧЕНИЕ(Справочник.CRM_ВидыОповещений.ЗапланированныеСобытия)
...
// Формирует напоминание о новом письме.
//
// Параметры:
...
Процедура ОповеститьАвтораПорученияОВыполненииЗадачи(Предмет, Просрочено = Ложь) Экспорт
	...
	Если НЕ Предмет.Исполнитель = Предмет.БизнесПроцесс.Автор Тогда
		...
		Если НЕ Просрочено Тогда
			...
			НСтр("ru = '  Выполнена задача: ""'") + Строка(Предмет.Наименование) + НСтр("ru='""  исполнитель:';en='""  executor:'") + " " + Предмет.Исполнитель;
		Иначе
			ТекстСодержания = НСтр("ru='Истек срок выполнения задачи ""';en='Period of execution of the task ""effusing'") +
...
Функция ПолучитьСуществующиеНапоминания(Предмет)
	...
	НаборРегистра.Отбор.Предмет.Установить(Предмет);
	НаборРегистра.Прочитать();
	ТаблицаОповещений = НаборРегистра.Выгрузить(,"СрокОповещения, Канал, Периодичность, ВидОповещения, Получатель, Предмет");
...
Процедура ФормированиеОповещений() Экспорт
	...
	|////////////////////////////////////////////////////////////////////////////////
	//|ВЫБРАТЬ
	//|	ПросроченныеВзаимодействия.Предмет,
	//|	ПросроченныеВзаимодействия.Пользователь,
	//|	ПросроченныеВзаимодействия.Напоминания,
	//|	ПросроченныеВзаимодействия.Оповещения
	//|ИЗ
	//|	(ВЫБРАТЬ
...
Процедура ОтправкаСМСОповещений() Экспорт
	...
	ЗаписьЖурналаРегистрации("Регламентное оповещение по SMS",
			УровеньЖурналаРегистрации.Информация, , ,
			НСтр("ru='Начато регламентное оповещение по SMS';en='The regulated notification on SMS are beg'"));
...
Процедура ОтправкаОповещенийЭлектроннойПочтой() Экспорт
	...
	ЗаписьЖурналаРегистрации("Регламентное оповещение по E-Mail",
			УровеньЖурналаРегистрации.Информация, , ,
			НСтр("ru='Начато регламентное оповещение по E-Mail';en='The regulated notification on the E-mail are beg'"));
	...
	ЗаписьЖурналаРегистрации("Регламентное оповещение по E-Mail", 
		УровеньЖурналаРегистрации.Информация, , ,
		НСтр("ru='Закончено регламентное оповещение по E-Mail';en='The regulated notification on the E-mail are finish'"));
...
Функция СформироватьТекстТемыИСодержанияОповещения(ПараметрыОповещения) Экспорт
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = "ПоступлениеОплаты" Тогда
		...
		Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			ТекстТемы				= НСтр("ru='Поступила оплата от клиента';en='Received payment from the customer'");
	...
	//				ТекстТемы	= НСтр("ru='Принята к исполнению задача""';en='The task is accepted to execution'") + Лев(СокрЛП(ПараметрыОповещения.Предмет.Наименование),50);
	//			Иначе
	//				ТекстТемы	= НСтр("ru='Выполнена задача""';en='Carried out task""'") + Лев(СокрЛП(ПараметрыОповещения.Предмет.Наименование),50);
	//			КонецЕсли;
	//		КонецЕсли;
	//		
	//		ТекстСодержания = ПараметрыОповещения.ТекстОповещения;
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.ЗапланированныеСобытия Тогда
		...
		Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			...
			Если ТипЗнч(ПараметрыОповещения.Предмет) = Тип("ЗадачаСсылка.ЗадачаИсполнителя") Тогда
				...
				ТекстСодержания = НСтр("ru='Напоминание: Запланирована задача ""';en='Reminder: The task"" are scheduled'") + Строка(ПараметрыОповещения.Предмет.Наименование) + НСтр("ru='"" начало в';en='"" starts at'") + " " + Формат(ПараметрыОповещения.Предмет.ДатаНачала,?(ПараметрыОповещения.ИспользоватьДатуИВремяВСрокахЗадач,"ДФ='дд.ММ.гг ЧЧ:мм'","ДФ='дд.ММ.гг'"));
				
			КонецЕсли;
			
			Если ТипЗнч(ПараметрыОповещения.Предмет) = Тип("ДокументСсылка.CRM_Взаимодействие") Тогда
				
				ТекстСодержания = НСтр("ru='Напоминание: Запланировано Взаимодействие ""';en='Reminder: Planned Interaction ""'") + Строка(ПараметрыОповещения.Предмет.Тема) + НСтр("ru='"" начало в';en='"" starts at'") + " " + Формат(ПараметрыОповещения.Предмет.ПлановаяДата,"ДФ='дд.ММ.гг ЧЧ:мм'");
		...
		Иначе
			...
			Если ТипЗнч(ПараметрыОповещения.Предмет) = Тип("ЗадачаСсылка.ЗадачаИсполнителя") Тогда
				...
				ТекстТемы = НСтр("ru='Напоминание: Запланирована задача ""';en='Reminder: The task"" are scheduled'") + Строка(ПараметрыОповещения.Предмет.Наименование) + НСтр("ru='"" начало в';en='"" starts at'") + " " + Формат(ПараметрыОповещения.Предмет.ДатаНачала,?(ПараметрыОповещения.ИспользоватьДатуИВремяВСрокахЗадач,"ДФ='дд.ММ.гг ЧЧ:мм'","ДФ='дд.ММ.гг'"));
				...
				ТекстСодержания = "
				|<p>" + НСтр("ru='Напоминание: Запланирована задача';en='Reminder: Task scheduled'") + "</p>
				|<p>%1" + НСтр("ru='"" начало в ';en='"" starts at'") + Формат(ПараметрыОповещения.Предмет.ДатаНачала,?(ПараметрыОповещения.ИспользоватьДатуИВремяВСрокахЗадач,"ДФ='дд.ММ.гг ЧЧ:мм'","ДФ='дд.ММ.гг'")) + "</p>";
			...
			Если ТипЗнч(ПараметрыОповещения.Предмет) = Тип("ДокументСсылка.CRM_Взаимодействие") Тогда
				...
				ТекстТемы = НСтр("ru='Напоминание: Запланировано Взаимодействие ""';en='Reminder: Planned Interaction ""'") + СокрЛП(Строка(ПараметрыОповещения.Предмет.Тема)) + """";
				...
				ИнформацияОтветственного = CRM_ОбщегоНазначенияСервер.ПолучитьКонтактнуюИнформациюОбъектаДляОповещений(ПараметрыОповещения.Предмет.Ответственный
																											...
																											Справочники.ВидыКонтактнойИнформации.EmailПользователя));
				ТекстСодержания = "
				|<p>" + НСтр("ru='Напоминание: Запланировано событие';en='Reminder: Event are scheduled'") + "</p>
				|<p>%1</p>";
				...
				Иначе
				ТекстСодержания = ТекстСодержания + "
				|<p>" + НСтр("ru = 'Описание: '") + НСтр("ru='не указано';en='it is not specif'") + "</p>";
				КонецЕсли;
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.ОповещатьОПереадресованныхДокументахЗадачах Тогда
		...
		Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			ТекстСодержания = ТекстСодержания + НСтр("ru='Переадресован';en='Redirected'") + " " + ТипОбъекта + ?(ТемаНаименование="",""," """+ТемаНаименование+"""") + НСтр("ru = ' от'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'");
		Иначе
			...
			ТекстТемы = ТекстСодержания + НСтр("ru='Переадресован';en='Redirected'") + " " + ТипОбъекта + ?(ТемаНаименование="",""," """+ТемаНаименование+"""") + НСтр("ru = ' от'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'");
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.ОповещатьОНовыхЗадачах Тогда
		...
		Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			...
			Если ТипЗнч(ПараметрыОповещения.Предмет) = Тип("ЗадачаСсылка.ЗадачаИсполнителя") Тогда
				...
				И ПараметрыОповещения.Предмет.БизнесПроцесс.КартаМаршрута = Справочники.CRM_КартыМаршрутов.Поручение Тогда
					ТекстСодержания = НСтр("ru='Новое поручение ""';en='New commission""'");
				Иначе
					ТекстСодержания = НСтр("ru='Новая задача ""';en='New task""'");
				КонецЕсли;
				
				ТекстСодержания = ТекстСодержания + ПараметрыОповещения.Предмет.Наименование;
				ТекстСодержания = ТекстСодержания + НСтр("ru='"" срок:';en='"" term:'") + " " + Формат(ПараметрыОповещения.Предмет.СрокИсполнения,"ДФ='дд.ММ.гг ЧЧ:мм'");
				ТекстСодержания = ТекстСодержания + НСтр("ru='"" Автор:';en='""  Author:'") + " " + ПараметрыОповещения.Предмет.Автор;
			ИначеЕсли ТипЗнч(ПараметрыОповещения.Предмет) = Тип("ДокументСсылка.CRM_ЭтапКалендарногоПлана") Тогда
				...
				ТекстСодержания = ТекстСодержания + НСтр("ru= 'ответственный:'") + " " + ПараметрыОповещения.Предмет.ОтветственныйИсполнитель;
			КонецЕсли;
		...
		Иначе
			Если ТипЗнч(ПараметрыОповещения.Предмет) = Тип("ЗадачаСсылка.ЗадачаИсполнителя") Тогда
				Если ЗначениеЗаполнено(ПараметрыОповещения.Предмет.БизнесПроцесс)
				И ПараметрыОповещения.Предмет.БизнесПроцесс.КартаМаршрута = Справочники.CRM_КартыМаршрутов.Поручение Тогда
					ТекстТемы	= НСтр("ru='Новое поручение ""';en='New commission ""'");
					Стр			= "<P>" + НСтр("ru='Новое поручение ""';en='New commission ""'");
				Иначе
					ТекстТемы	= НСтр("ru='Новая задача ""';en='New task ""'");
					Стр			= "<P>" + НСтр("ru='Новая задача ""';en='New task ""'");
				КонецЕсли;
				...
				Стр = Стр + "<P>" + НСтр("ru='"" срок:';en='"" term:'") + " " + Формат(ПараметрыОповещения.Предмет.СрокИсполнения,"ДФ='дд.ММ.гг ЧЧ:мм'");
				...
				Стр_1 = "<P><span style='font-size: 10pt;'><span style='font-size: 10pt;'><EM><STRONG>" + НСтр("ru='Задача';en='Task'")+"</STRONG></EM></span></P>";
			...
			ИначеЕсли ТипЗнч(ПараметрыОповещения.Предмет) = Тип("ДокументСсылка.CRM_ЭтапКалендарногоПлана") Тогда
				...
				//Стр	= Стр + СокрЛП(ПараметрыОповещения.Предмет.Наименование) + """</P></BR>";
				Стр = Стр + "<P>" + НСтр("ru='Дата начала:'") + " " + Формат(ПараметрыОповещения.Предмет.ПлановаяДатаНачала,"ДФ='дд.ММ.гггг'");
				Стр = Стр + "<P>" + НСтр("ru='Дата окончания:'") + " " + Формат(ПараметрыОповещения.Предмет.ПлановаяДатаОкончания,"ДФ='дд.ММ.гггг'");
				Стр = Стр + "<P>" + НСтр("ru='Проект:'") + " " + ПараметрыОповещения.Предмет.Проект;
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.ЗавершениеБизнесПроцесса Тогда
		...
		Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			ТекстСодержания = НСтр("ru='Завершен бизнес-процесс ""';en='Business process"" is completed'") + Строка(ПараметрыОповещения.Предмет.Наименование) +
			НСтр("ru='"" от';en='"" from'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'");
		Иначе
			...
			ТекстТемы = НСтр("ru='Завершен бизнес-процесс ""';en='Business process"" is completed'") + Строка(ПараметрыОповещения.Предмет.Наименование) +
			НСтр("ru='"" от';en='"" from'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'");
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.ПросроченныеНеЗавершенныеСобытияЗадачи Тогда
		...
		Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			Если ТипЗнч(ПараметрыОповещения.Предмет) = Тип("ЗадачаСсылка.ЗадачаИсполнителя") Тогда
				ТекстСодержания = НСтр("ru='Истек срок выполнения задачи ""';en='Period of execution of the task ""effusing'") + Строка(ПараметрыОповещения.Предмет.Наименование) + НСтр("ru='"" срок:';en='"" term:'") + " " + Формат(ПараметрыОповещения.Предмет.СрокИсполнения,?(ПараметрыОповещения.ИспользоватьДатуИВремяВСрокахЗадач,"ДФ='дд.ММ.гг ЧЧ:мм'","ДФ='дд.ММ.гг'"));
			КонецЕсли;
		...
		Иначе
			...
			Если ТипЗнч(ПараметрыОповещения.Предмет) = Тип("ЗадачаСсылка.ЗадачаИсполнителя") Тогда
				ТекстТемы = НСтр("ru='Истек срок выполнения задачи ""';en='Period of execution of the task ""effusing'") + ТемаНаименование + НСтр("ru='"" срок:';en='"" term:'") + " " + Формат(ПараметрыОповещения.Предмет.СрокИсполнения,?(ПараметрыОповещения.ИспользоватьДатуИВремяВСрокахЗадач,"ДФ='дд.ММ.гг ЧЧ:мм'","ДФ='дд.ММ.гг'"));
...
// ************************************************************************
		...
		Если ТипЗнч(ПараметрыОповещения.Предмет) = Тип("СправочникСсылка.Партнеры") Тогда
			...
			Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
				...
				ТекстСодержания = СтрокаДаты + НСтр("ru = '  у партнера:'") + " " + ПараметрыОповещения.Предмет.Наименование + НСтр("ru='  День Рождения.';en=' Birthday.'");
				
			Иначе
				ТекстТемы = НСтр("ru='День рождения партнера';en='Birthday of the partner'");
		...
		ИначеЕсли ТипЗнч(ПараметрыОповещения.Предмет) = Тип("СправочникСсылка.КонтактныеЛицаПартнеров") Тогда
			...
			Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
				...
				ТекстСодержания = СтрокаДаты + НСтр("ru = '  у :'") + " " + ПараметрыОповещения.Предмет.Наименование + "(" + ПараметрыОповещения.Предмет.Владелец.Наименование + ")" +НСтр("ru='  День Рождения.';en=' Birthday.'");
				
			Иначе
				ТекстТемы = НСтр("ru='День рождения контактного лица партнера';en='Birthday of the contact person of the partner'");
				ТекстСодержания = СтрокаДаты + НСтр("ru = '  у :'") + " " + ПараметрыОповещения.Предмет.Наименование + "(" + ПараметрыОповещения.Предмет.Владелец.Наименование + ")" +НСтр("ru='  День Рождения.';en=' Birthday.'");
			КонецЕсли;
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.ПросроченныеКонтрольныеТочки Тогда
		...
		Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			ТекстСодержания = НСтр("ru='Истек срок проведения контрольной точки ""';en='Period of carrying out of test point ""effusing'") + Строка(ПараметрыОповещения.Предмет.Тема) + НСтр("ru='"" дата начала:';en='""  start sate:'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'");
			
		Иначе
			ПредставлениеСсылки = Строка(ПараметрыОповещения.Предмет.Тема) + НСтр("ru=' дата начала: ';en='start date:'") + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'");
			...
			ТекстТемы = НСтр("ru='Истек срок проведения контрольной точки ""';en='Period of carrying out of test point ""effusing'") + Строка(ПараметрыОповещения.Предмет.Тема) + НСтр("ru='"" дата начала:';en='""  start sate:'") + " " + Формат(ПараметрыОповещения.Предмет.Дата,"ДФ='дд.ММ.гг ЧЧ:мм'");
			...
			ТекстСодержания = ТекстСодержания + "
			|<p>" + НСтр("ru='Участники:';en='Participants:'") + "</p>
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.ДействияПоПартнерам Тогда
		Если ПараметрыОповещения.Свойство("Партнеры") Тогда
			Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
				...
				ТекстСодержания = ТекстСодержания
				+ НСтр("ru='Новый документ ""';en='New document""'")
				+ ПредставлениеПредмета
				+ НСтр("ru='"" по';en='"" till'") + " "
				+ ?(ПараметрыОповещения.Партнеры.Количество() = 1, НСтр("ru='партнеру';en='to the partner'"), НСтр("ru='партнерам';en='to partners'"));
				//
			...
			Иначе
				...
				|<p>%"+Строка(Ном)+"</p>
				|<p>" + НСтр("ru = 'по '") + ?(ПараметрыОповещения.Партнеры.Количество() = 1,НСтр("ru='партнеру';en='to the partner'"),НСтр("ru='партнерам';en='to partners'")) + "</p>";
				...
				ТекстТемы = ТекстТемы + НСтр("ru='Новый документ ""';en='New document""'")
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.ДействияПоПроектам Тогда
		Если ПараметрыОповещения.Свойство("Проекты") Тогда
			Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
				...
				+ ПредставлениеПредмета
				+ НСтр("ru='"" по';en='"" till'") + " "
				+ ?(ПараметрыОповещения.Проекты.Количество() = 1, НСтр("ru='проекту';en='to the project'"), НСтр("ru='проектам';en='to projects'"));
				//
			...
			Иначе
				...
				|<p>" + НСтр("ru = 'Новый документ '") + "</p>
				|<p>%"+Строка(Ном)+"</p>
				|<p>" + НСтр("ru = 'по '") + ?(ПараметрыОповещения.Партнеры.Количество() = 1,НСтр("ru='проекту';en='to the project'"),НСтр("ru='проектам';en='to projects'")) + "</p>";
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.КоммерческоеПредложениеСумма Тогда
		...
		Если ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.Напоминание Тогда
			...
			Если CRM_ОбщегоНазначенияПовтИсп.ЭтоCRM() Тогда
				ТекстСодержания = ТекстСодержания + НСтр("ru=' Договор:';en='Contract:'") + " " + ПараметрыОповещения.Предмет.Договор;
			Иначе	
				ТекстСодержания = ТекстСодержания + НСтр("ru = ' Соглашение:'") + " " + ПараметрыОповещения.Предмет.Соглашение;
			КонецЕсли;	
		...
		ИначеЕсли ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			...
			Если CRM_ОбщегоНазначенияПовтИсп.ЭтоCRM() Тогда
				ТекстДоговор = НСтр("ru=' Договор: ';en='Contract: '") + ПараметрыОповещения.Предмет.Договор;
			Иначе	
				ТекстДоговор = НСтр("ru = ' Соглашение: '") + ПараметрыОповещения.Предмет.Соглашение;
			КонецЕсли;	
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.СчетСумма Тогда
		...
		Если ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.Напоминание Тогда
			...
			НСтр("ru = ' Организация:'") + " " + ПараметрыОповещения.Предмет.Организация + Символы.ПС +
			НСтр("ru = ' Клиент:'") + " " + ПараметрыОповещения.Предмет.Партнер + Символы.ПС +
			НСтр("ru=' Договор:';en='Contract:'") + " " + ПараметрыОповещения.Предмет.Договор;
		...
		ИначеЕсли ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			...
			|<p>" + НСтр("ru = ' Организация: '") + ПараметрыОповещения.Предмет.Организация + "</p>
			|<p>" + НСтр("ru = ' Клиент: '") + ПараметрыОповещения.Предмет.Партнер + "</p>
			|<p>" + НСтр("ru=' Договор: ';en='Contract: '") + ПараметрыОповещения.Предмет.Договор + "</p>";
	...
	ИначеЕсли ПараметрыОповещения.ВидОповещения = Справочники.CRM_ВидыОповещений.ОповещатьОбОкончанииСрокаЗадач Тогда
		Если НЕ ПараметрыОповещения.Канал = Перечисления.CRM_КаналыОповещений.ЭлектроннаяПочта Тогда
			...
			ТекстСодержания = НСтр("ru='Истекает срок выполнения задачи ""';en='Expiration of the task ""'") + Строка(ПараметрыОповещения.Предмет.Наименование) + НСтр("ru='"" срок:';en='"" term:'") + " " + Формат(ПараметрыОповещения.Предмет.СрокИсполнения,?(ПараметрыОповещения.ИспользоватьДатуИВремяВСрокахЗадач,"ДФ='дд.ММ.гг ЧЧ:мм'","ДФ='дд.ММ.гг'"));
		...
		Иначе
			...
			ТекстТемы = НСтр("ru='Истекает срок выполнения задачи ""';en='Expiration of the task ""'") + ТемаНаименование + НСтр("ru='"" срок:';en='"" term:'") + " " + Формат(ПараметрыОповещения.Предмет.СрокИсполнения,?(ПараметрыОповещения.ИспользоватьДатуИВремяВСрокахЗадач,"ДФ='дд.ММ.гг ЧЧ:мм'","ДФ='дд.ММ.гг'"));
...
Функция ПолучитьПараметрыОповещенияЗапланированныеСобытия(Пользователь, Предмет) Экспорт
	...
	ТаблицаОповещений.Колонки.Добавить("ДатаОповещения", Новый ОписаниеТипов("Дата",,, Новый КвалификаторыДаты(ЧастиДаты.ДатаВремя)));
...
Процедура ПриЗаписиОбъектаОповещения(Источник, Отказ) Экспорт
	...
	Если Источник.ДополнительныеСвойства.Свойство("НеСоздаватьОповещенияПоУмолчанию") Тогда
		Возврат;
	КонецЕсли;
	...
	ИначеЕсли ТипЗнч(Источник) = Тип("ЗадачаОбъект.ЗадачаИсполнителя") Тогда
		...
		Если НЕ (Источник.Выполнена) И
			...
			Если ТаблицаОповещений.Количество() > 0 Тогда
				ТаблицаНастроекОповещений = ТаблицаОповещений;
			Иначе	
				ТаблицаНастроекОповещений = ПолучитьПараметрыОповещенияЗапланированныеСобытия(Источник.Исполнитель, Источник.Ссылка);
			КонецЕсли;
			МассивСтруктур = Новый Массив;
			Для Каждого СтрокаОповещения ИЗ ТаблицаНастроекОповещений Цикл
				СтруктураОповещения = Новый Структура;
