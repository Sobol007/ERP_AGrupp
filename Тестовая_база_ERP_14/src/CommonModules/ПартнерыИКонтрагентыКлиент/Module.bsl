...
Процедура ПартнерыФормаСпискаВыбораСписокПередНачаломДобавления(Форма, Элемент, Отказ, Копирование, Родитель, Группа, Основание = Неопределено) Экспорт
	...
	// +CRM
	CRM_МетодыФормСправочниковКлиент.ПартнерыФормаСпискаВыбораСписокПередНачаломДобавления(Форма, Элемент, Отказ, Копирование, Родитель, Группа, Основание);
	Возврат;
	// -CRM
...
Процедура ПартнерыФормаСпискаВыбораСоздатьНового(Форма, Команда) Экспорт
	...
	// +CRM
	CRM_Модуль_РаботаСКонтрагентамиКлиент.ОткрытьФормуПартнераСоответствующуюИнтерфейсу(Форма, СтруктураПараметры);
	Возврат;
	// -CRM
