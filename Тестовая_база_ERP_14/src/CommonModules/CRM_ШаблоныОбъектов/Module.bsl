...
Процедура СформироватьДополнительныеЭлементыФормы(Форма) Экспорт
	...
	Если ГруппаФормы = Неопределено Тогда
		...
		ГруппаФормы.Заголовок = НСтр("ru='Шаблоны';en='Templates'");
	КонецЕсли;
	...
	Если Форма.Команды.Найти(ИмяКомандыЗагрузки) = Неопределено Тогда
		...
		Команда.Заголовок = НСтр("ru='Заполнить из шаблона';en='Fill in from template'");
		Команда.Подсказка = НСтр("ru='Заполнить документ на основании ранее сохраненного шаблона';en='Fill the document on the basis of earlier saved template'");
	...
	Если Форма.Команды.Найти(ИмяКомандыВыгрузки) = Неопределено Тогда
		...
		Команда.Заголовок = НСтр("ru='Выгрузить в шаблон';en='Unload in a template'");
	...
	Если НЕ (ГруппаФормы = Неопределено) Тогда
		...
		Если Форма.Элементы.Найти(ИмяКнопкиЗагрузкиВГруппе) = Неопределено Тогда
			...
			КнопкаЗагрузкиИзШаблона.Заголовок = НСтр("ru='Заполнить из шаблона';en='Fill in from template'");
