...
Функция РезультатыРаспределенияНДФЛ(ДанныеДляПроведения, РезультатыРасчетаНДФЛ)
	...
	Возврат УчетНачисленнойЗарплаты.РаспределениеПрочихУдержанийПоРабочимМестам(УдержанияКРаспределению, ПериодРегистрации, Организация, БазаРасчетаНДФЛ, УжеУчтеноУдержаний, Перечисления.ВидыОсобыхНачисленийИУдержаний.НДФЛ, 0, Авансом, Ложь);
