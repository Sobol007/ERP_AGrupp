...
Функция ПолучитьРуководителейПользователя(Пользователь) Экспорт
	...
	Если ЗначениеЗаполнено(Пользователь) Тогда
		...
		|ГДЕ
		|	Пользователи.ФизическоеЛицо = &ТекущийРуководитель";
		Для Каждого ЭлементМассива Из МассивПодразделений Цикл
			...
			Если CRM_ОбщегоНазначенияПовтИсп.ЭтоCRM() Тогда
				МассивРуководителей.Добавить(ЭлементМассива.ТекущийРуководитель);
			Иначе				
				Запрос.УстановитьПараметр("ТекущийРуководитель", ЭлементМассива.ТекущийРуководитель);				
				Выборка = Запрос.Выполнить().Выбрать();
				Пока Выборка.Следующий() Цикл
