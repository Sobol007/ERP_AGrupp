...
#Если ВебКлиент Тогда
	...
	ТекстСообщения = НСтр("ru = 'Обновление программы недоступно в веб-клиенте.';
							|en = 'Updating the application in web client is unavailable.'");
	
#ИначеЕсли МобильныйКлиент Тогда
	
	ВозможенЗапускОбновления = Ложь;
	ТекстСообщения = НСтр("ru = 'Обновление программы недоступно в мобильном клиенте.';
							|en = 'Updating the application in mobile client is unavailable.'");
...
#Иначе
	...
	Если Не ОбщегоНазначенияКлиент.ЭтоWindowsКлиент() Тогда
		...
		ТекстСообщения = НСтр("ru = 'Обновление программы доступно только в клиенте под управлением ОС Windows.';
								|en = 'You can update the application in a client running Windows OS only.'");
	КонецЕсли;
	...
	Если ОбщегоНазначенияКлиент.КлиентПодключенЧерезВебСервер() Тогда
		...
		ТекстСообщения = НСтр("ru = 'Обновление программы недоступно при подключении через веб-сервер.';
								|en = 'Updating the application using web server connection is unavailable.'");
	КонецЕсли;
