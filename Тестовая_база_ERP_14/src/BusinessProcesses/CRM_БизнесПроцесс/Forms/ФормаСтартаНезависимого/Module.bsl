...
Процедура ПриИзмененииШаблона(ПриСоздании=Ложь)
	...
	Если ЗначениеЗаполнено(Шаблон) Тогда
		...
		Элементы.ГруппаИсполнители.Видимость = (Объект.КартаМаршрута.РедактироватьИсполнителейЭтапов ИЛИ Объект.КартаМаршрута.УказыватьСрокВыполненияЭтапов);
		Элементы.Исполнители_ИсполнительПредставление.ТолькоПросмотр = НЕ Объект.КартаМаршрута.РедактироватьИсполнителейЭтапов;
