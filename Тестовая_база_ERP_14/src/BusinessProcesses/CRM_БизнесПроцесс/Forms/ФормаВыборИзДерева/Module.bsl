...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		Элементы.ОтборПодразделение.СписокВыбора.Добавить("Подразделение не выбрано", НСтр("ru='Подразделение не выбрано';en='Unit not selected'"));
...
Процедура ОтборПодразделениеОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Иначе
		...
		Элементы.ОтборПодразделение.СписокВыбора.Добавить(?(ЗначениеЗаполнено(ТекущееПодразделение), ТекущееПодразделение, "Подразделение не выбрано"), 
			?(ЗначениеЗаполнено(ТекущееПодразделение), НСтр("ru='Мое подразделение (';en='My unit ('") + ТекущееПодразделение + ")", НСтр("ru='Подразделение не выбрано';en='Unit not selected'")));
...
Процедура ОтборПодразделениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	Элементы.ОтборПодразделение.СписокВыбора.Очистить();
	Элементы.ОтборПодразделение.СписокВыбора.Добавить(ПредопределенноеЗначение("Справочник.СтруктураПредприятия.ПустаяСсылка"), НСтр("ru='Все подразделения';en='All units'"));
	Элементы.ОтборПодразделение.СписокВыбора.Добавить(?(ЗначениеЗаполнено(ТекущееПодразделение), ТекущееПодразделение, "Подразделение не выбрано"), 
			?(ЗначениеЗаполнено(ТекущееПодразделение), НСтр("ru='Мое подразделение (';en='My unit ('") + ТекущееПодразделение + ")", НСтр("ru='Подразделение не выбрано';en='Unit not selected'")));
	Элементы.ОтборПодразделение.СписокВыбора.Добавить("ВыбратьИзСписка", НСтр("ru='Выбрать из списка...';en='Choose from the list ...'"));
КонецПроцедуры
