...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Данные") Тогда
		Если Параметры.Данные = "Клиенты" Тогда
			Заголовок = НСтр("ru='Настройка истории изменения данных клиентов';en=""Setting history of customer's data""");
			Элементы.ГруппаИнтересы.Видимость = Ложь;
		ИначеЕсли Параметры.Данные = "Интересы" Тогда
			Заголовок = НСтр("ru='Настройка истории изменения данных интересов';en='Configure the history of changing lead data'");
	...
	Если ТипЗнч(СтруктураНастройки) = Тип("Структура") И ТипЗнч(СтруктураНастройки.СтруктураНастройки) = Тип("Структура") Тогда
		...
		Если СтруктураНастройки.СтруктураНастройки.Свойство("РеквизитыКонтактногоЛица") И ТипЗнч(СтруктураНастройки.СтруктураНастройки.РеквизитыКонтактногоЛица) = Тип("Массив") Тогда
			...
			КонецЦикла;
		КонецЕсли;
		Если СтруктураНастройки.СтруктураНастройки.Свойство("РеквизитыИнтереса") И ТипЗнч(СтруктураНастройки.СтруктураНастройки.РеквизитыИнтереса) = Тип("Массив") Тогда
...
Процедура КомандаОКЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	Если Ответ = КодВозвратаДиалога.Да Тогда
		...
		Состояние(НСтр("ru='Первоначальное заполнение выполнено';en='Initiating filling are fulfill'"));
	КонецЕсли;
	Закрыть();
КонецПроцедуры
