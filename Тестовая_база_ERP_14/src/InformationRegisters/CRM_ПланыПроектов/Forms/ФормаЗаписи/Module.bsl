...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	Если СоздатьКонтрольнуюТочкуНачала Тогда
		...
		Если ТипЗнч(КТНачала) = Тип("Строка") Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Ошибка при создании контрольной точки начала:';en='Error at creation of test point of the beginning:'") + " """ + КТНачала + """",, "СоздатьКонтрольнуюТочкуНачала");
	...
	Если СоздатьКонтрольнуюТочкуОкончания И Не бОшибкаПриСозданииКонтрольнойТочкиНачала Тогда
		...
		Если ТипЗнч(КТОкончания) = Тип("Строка") Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Ошибка при создании контрольной точки окончания:';en='Error at creation of test point of the termination:'") + " """ + КТОкончания + """",, "СоздатьКонтрольнуюТочкуОкончания");
