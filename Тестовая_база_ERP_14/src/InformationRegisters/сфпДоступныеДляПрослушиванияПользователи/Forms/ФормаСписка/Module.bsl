...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИспользоватьГруппыПользователей Тогда
		Элементы.КонтролируемыйПользователь.Заголовок = НСтр("ru='Контролируемый пользователь / группа пользователей';en='Controllable user / group of users'");
	Иначе	
		Элементы.КонтролируемыйПользователь.Заголовок = НСтр("ru='Контролируемый пользователь';en='Controllable user'");
		Отбор = Список.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
