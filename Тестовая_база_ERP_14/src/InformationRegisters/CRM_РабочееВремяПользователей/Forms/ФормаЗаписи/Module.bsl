...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если CRM_ОбщегоНазначенияПовтИсп.ЭтоCRM() Тогда
		РуководительПодразделения = Запись.Пользователь.Подразделение.ТекущийРуководитель;
	Иначе
		Запрос = Новый Запрос;
		...
		Запрос.УстановитьПараметр("ФизическоеЛицо", Запись.Пользователь.Подразделение.ТекущийРуководитель);
	...
	Если (Запись.Пользователь <> Пользователи.АвторизованныйПользователь()) И (НЕ РольДоступна("ПолныеПрава")) И (НЕ РуководительПодразделения = Пользователи.АвторизованныйПользователь()) Тогда
