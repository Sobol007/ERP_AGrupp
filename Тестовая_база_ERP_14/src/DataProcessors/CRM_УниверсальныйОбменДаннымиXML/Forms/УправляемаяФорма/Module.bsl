...
Процедура СохранитьПараметрыНаСервере()
	...
	ХранилищеСистемныхНастроек.Сохранить("CRM_УниверсальныйОбменДаннымиXML", "Параметры", СохраняемыеПараметры);
...
Процедура ВосстановитьПараметрыНаСервере()
	...
	ТаблицаПараметров = РеквизитФормыВЗначение("Объект.ТаблицаНастройкиПараметров");
	ВосстановленныеПараметры = ХранилищеСистемныхНастроек.Загрузить("CRM_УниверсальныйОбменДаннымиXML", "Параметры");
