...
// +CRM
Функция ВыгрузитьДанныеCRM() Экспорт
	РаботаВозможна = ВыполнитьДействияПередЧтениемДанных();
...
Функция ВыполнитьВыгрузкуИзмененныхДанныхДляУзлаОбменаCRM(УзелОбмена, МассивПравилКонвертации, СтруктураДляУдаленияРегистрацииИзменений, МассивОбъектовДляВыгрузки)
	...
	Попытка
		...
		//Пока ВыборкаИзменений.Следующий() Цикл
			...
			//Данные = ВыборкаИзменений.Получить();
		Для Каждого Данные Из МассивОбъектовДляВыгрузки Цикл
...
Функция ОбработатьВыгрузкуДляПлановОбменаCRM(СоответствиеУзловИПравилВыгрузки, СтруктураДляУдаленияРегистрацииИзменений, МассивОбъектовДляВыгрузки)
	...
	Для Каждого СтрокаСоответствия Из СоответствиеУзловИПравилВыгрузки Цикл
		...
		ТекущаяУдачнаяВыгрузка = ВыполнитьВыгрузкуИзмененныхДанныхДляУзлаОбменаCRM(УзелОбмена, МассивПравилКонвертации, ЛокальнаяСтруктураДляУдаленияРегистрацииИзменений, МассивОбъектовДляВыгрузки);
...
//  Нет.
//
Процедура ВыполнитьВыгрузкуCRM(МассивОбъектовДляВыгрузки, РезультатВыгрузки) Экспорт
	...
	Попытка
		...
		Если Не Отказ Тогда
			...
			Если Не Отказ Тогда
				...
				УдачноВыгруженоПоПланамОбмена = ОбработатьВыгрузкуДляПлановОбменаCRM(СоответствиеУзловИПравилВыгрузки, СтруктураДляУдаленияРегистрацииИзменений, МассивОбъектовДляВыгрузки);
