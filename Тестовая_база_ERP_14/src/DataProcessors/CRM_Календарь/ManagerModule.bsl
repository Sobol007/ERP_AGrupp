...
// Возвращает структуру, содержащую имена для описания события 
// 
// Возвращаемое значение:
//   Структура - содержит имена (ключи) события. 
//
...
// Функция заполняет дополнительные свойства события.
//
// Параметры:
//  ОписаниеСобытия		 - Структура - Описание события. 
//  НастройкиОтображения - Структура - Настройки отображения.
// 
// Возвращаемое значение:
//  Неопределено - Заполнение дополнительных свойств. 
//
Функция ЗаполнитьДополнительныеСвойстваСобытия(ОписаниеСобытия, НастройкиОтображения) Экспорт
	Если ТипЗнч(ОписаниеСобытия.Событие) = Тип("ДокументСсылка.CRM_ЭтапКалендарногоПлана") Тогда
