...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Если Параметры.Свойство("ВладелецКлассификации", ВладелецКлассификации) Тогда
		CRM_КлассификаторыВызовСервера.ФормаОбъектаПриЧтенииНаСервере(ЭтаФорма, ВладелецКлассификации);
	КонецЕсли;
КонецПроцедуры
...
Процедура ГотовоНаСервере()
	...
	CRM_КлассификаторыВызовСервера.ФормаОбъектаПослеЗаписиНаСервере(ЭтотОбъект, ОбъектКлассификации);
