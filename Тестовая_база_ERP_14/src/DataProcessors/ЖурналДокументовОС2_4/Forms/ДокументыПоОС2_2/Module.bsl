...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("КлючНазначенияФормы")
		...
		КлючНазначенияИспользования = Обработки.ЖурналДокументовОС2_4.КлючНазначенияФормыПоУмолчанию2_2();
		КлючНастроек = "";
	Иначе
...
Процедура ВосстановитьНастройки()
	...
	Настройки = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("Обработка.ЖурналДокументовОС2_4.Форма.ДокументыПоОС2_2", КлючНазначенияИспользования);
...
Процедура СохранитьНастройки()
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("Обработка.ЖурналДокументовОС2_4.Форма.ДокументыПоОС2_2", КлючНазначенияИспользования, Настройки);
...
Процедура ЗаполнитьРеквизитыФормыПриСоздании()
	...
	ТаблицаЗначенийДоступно = Обработки.ЖурналДокументовОС2_4.ИнициализироватьХозяйственныеОперацииИДокументы2_2(
