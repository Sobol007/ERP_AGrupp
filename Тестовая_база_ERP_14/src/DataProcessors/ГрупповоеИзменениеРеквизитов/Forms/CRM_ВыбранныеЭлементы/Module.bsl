...
Процедура ОбновитьСписокВыбранныхНаСервере()
	...
	Если КоличествоВыбранных > 1000 Тогда
		КоличествоВыбранных = НСтр("ru='> 1000';en='> 1000'");
	...
	КонецЕсли;
	Элементы.ГруппаВыбранныеОбъекты.Заголовок = ПодставитьПараметрыВСтроку(НСтр("ru='Выбранные элементы (%1)';en='Selected items ( %1)'"), КоличествоВыбранных);
