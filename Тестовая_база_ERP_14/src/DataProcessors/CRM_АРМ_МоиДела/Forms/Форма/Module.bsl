...
Процедура ОбновитьЗаголовкиТаблиц()
	...
	Иначе	
		Элементы["ЗаголовокВходящие"].Заголовок = НСтр("ru = 'Входящие'");
	КонецЕсли;	
	...
	Иначе	
		Элементы["ЗаголовокОтложенные"].Заголовок = НСтр("ru = 'Отложенные'");
	КонецЕсли;
	...
	Иначе	
		Элементы["ЗаголовокТекущие"].Заголовок = НСтр("ru = 'Текущие'");
	КонецЕсли;
...
Процедура УстановитьШиринуКолонокКанбан()
	...
	//Если ОбщегоНазначенияКлиентСервер.ЭтоВебКлиент() Тогда
	ШиринаЭлемента = ШиринаКолонокКанбан - 22;
	//Иначе
	//	ШиринаЭлемента = ШиринаКолонокКанбан - 22;
	//КонецЕсли;
