...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел2" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Ветка.Данные.Вставить("П000020013003", Ветка.Данные["П000020011003"] * Ветка.Данные["П000020012003"] / 100);
	...
	ИначеЕсли ИмяРаздела = "Приложение1" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Для каждого СтрокаМнЧ Из ДеревоМнЧ.Строки Цикл
				...
				СтрокаМнЧ.Данные.Вставить("П00101М101003",
	...
	ИначеЕсли ИмяРаздела = "Приложение3" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Для каждого СтрокаМнЧ Из ДеревоМнЧ.Строки Цикл
				...
				СтрокаМнЧ.Данные.Вставить("П00103М107003", СтрокаМнЧ.Данные["П00103М108003"] * СтрокаМнЧ.Данные["П00103М109003"]);
				
				СтрокаМнЧ.Данные.Вставить("П00103М102003",
	...
	ИначеЕсли ИмяРаздела = "Приложение7" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			ВеткаПриложения.Данные.Вставить("П001070040003", ВеткаПриложения.Данные["П001070050003"]
			* ВеткаПриложения.Данные["П001070060003"]);
			...
			ВеткаПриложения.Данные.Вставить("П001070090003", ВеткаПриложения.Данные["П001070070003"]
			* ВеткаПриложения.Данные["П001070080003"] / 100);
