...
Функция УниверсальнаяВыгрузка(Параметры) Экспорт
	...
	ПараметрыВыгрузки = ПараметрыВыгрузкиОтчета(ИмяФормы, СтруктураРеквизитовФормы,
												ДанныеОтчета, РеглОтчетВыгружаетсяВБанк);
...
Функция ИзвлечьСтруктуруXML(ИмяФормы, СтруктураРеквизитовФормы) Экспорт
	...
	Если СтруктураРеквизитовФормы.мСохраненныйДок.ДатаПодписи >= '2016-01-01' Тогда
		Макет = ЭтотОбъект.ПолучитьМакет("СхемаВыгрузки507");
	ИначеЕсли СтруктураРеквизитовФормы.мСохраненныйДок.ДатаПодписи >= '2015-01-01' Тогда
		Макет = ЭтотОбъект.ПолучитьМакет("СхемаВыгрузки506");
	ИначеЕсли СтруктураРеквизитовФормы.мСохраненныйДок.ДатаПодписи >= '2013-01-01' Тогда
		Макет = ЭтотОбъект.ПолучитьМакет("СхемаВыгрузки505");
	ИначеЕсли СтруктураРеквизитовФормы.мСохраненныйДок.ДатаПодписи >= '2012-01-01' Тогда
