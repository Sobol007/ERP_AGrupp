...
Процедура ВывестиСтрокиТаблицы(Результат, ПараметрыОтчета, Макет, ЦелевыеПараметры = Неопределено)
	...
	Для каждого Правило Из ПравилаРасчетаПоказателей Цикл
		...
		Если Прав(КодПоказателя, 2) = "00" ИЛИ КодПоказателя = "501" Тогда
			Уровень = 1;
		...
		Если (Раздел = "1" ИЛИ Раздел = "2") И Уровень <> 3 Тогда
			Продолжить;
		КонецЕсли;
...
Функция ПолучениеДанных(ПараметрыОтчета, ПравилаРасчетаПоказателей, ЦелевыеПараметры = Неопределено)
	...
	|		КОГДА ХозрасчетныйОбороты.Счет В (&СчетаУчетаДенеженыеСредстваНаСчетах)
	...
	ТипыПлатежейВыводИзКонтракта.Добавить(Справочники.ТипыПлатежейФЗ275.ОплатаИныхРасходовВПределахУстановленнойСуммыВМесяц);
	...
	Запрос.УстановитьПараметр("СчетаУчетаДенеженыеСредстваНаСчетах",      СчетаУчетаДенеженыеСредстваНаСчетах());
...
#Область ФинансированиеКонтракта
	...
	// 102 "Кредиты банка"
	НовоеПравило = ПравилаРасчетаПоказателей.Добавить(); 
	НовоеПравило.ГруппаПоказателей1 = "";
	НовоеПравило.ГруппаПоказателей2 = "";
...
#Область ОтгрузкаПродукцииВыполнениеРабот
	...
	НовоеПравило = ПравилаРасчетаПоказателей.Добавить(); 
	НовоеПравило.ГруппаПоказателей1 = "300";
	НовоеПравило.ГруппаПоказателей2 = "307";
	НовоеПравило.КодПоказателя = "307";
	НовоеПравило.Пассивный     = Истина;
	...
	ПравилоСебестоимость = ПравилаРасчетаПоказателей.Найти("302", "КодПоказателя");
	...
	ПравилоУправленческиеРасходы = ПравилаРасчетаПоказателей.Найти("303", "КодПоказателя");
	...
	ПравилоКоммерческиеРасходы = ПравилаРасчетаПоказателей.Найти("304", "КодПоказателя");
	...
	ПравилоПроцентыПоКредитам = ПравилаРасчетаПоказателей.Найти("305", "КодПоказателя");
