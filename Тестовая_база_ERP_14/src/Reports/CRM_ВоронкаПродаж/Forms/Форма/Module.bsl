...
Процедура ОбновитьДиаграммуНаСервере()
	...
	Элементы.ДекорацияСредняяДлительностьИнтересов.Заголовок = НСтр("ru = 'Средняя длительность - '")+ Строка(ОбщаяДлительность)+ НСтр("ru=' дней';en='days'");
