...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Этап.ВидЭтапа = Перечисления.CRM_ВидыЭтаповВоронкиПродаж.ПоДокументам Тогда
		...
		СхемаКомпоновкиДанных = Отчеты.CRM_ВоронкаПродаж.ПолучитьМакет("СхемаКомпоновкиДанныхРасшифровкаДиаграммыПоДокументам");
	...
	ИначеЕсли Параметры.Этап.ВидЭтапа = Перечисления.CRM_ВидыЭтаповВоронкиПродаж.ПоЭтапам Тогда
		...
		СхемаКомпоновкиДанных = Отчеты.CRM_ВоронкаПродаж.ПолучитьМакет("СхемаКомпоновкиДанныхРасшифровкаДиаграммы");
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыНастройкиКомпоновщикаПользовательскиеНастройки
